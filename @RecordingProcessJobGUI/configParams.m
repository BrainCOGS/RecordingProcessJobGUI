...
app.preparam_steps_name_field = 'preprocess_param_steps_name';
app.preparam_steps_desc_field = 'preprocess_param_steps_desc';
...
app.preparam_steps_table_names.electrophysiology.preprocess_idx_field = ...
    'precluster_param_steps_id';
app.preparam_steps_table_names.electrophysiology.preprocess_name_field = ...
    'precluster_param_steps_name';
app.preparam_steps_table_names.electrophysiology.preprocess_desc_field = ...
...
app.preparam_steps_table_names.imaging.preprocess_idx_field = ...
    'preprocess_param_steps_id';
app.preparam_steps_table_names.imaging.preprocess_name_field = ...
    'preprocess_param_steps_name';
app.preparam_steps_table_names.imaging.preprocess_desc_field = ...
...
app.preparam_steps_step_table_names.electrophysiology.preprocess_idx_field = ...
    'precluster_param_steps_id';
...
app.preparam_steps_step_table_names.imaging.preprocess_idx_field = ...
    'preprocess_param_steps_id';
