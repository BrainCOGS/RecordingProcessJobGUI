...
app.GridLayout3.RowHeight = {'1x', '1x', 2, '1x', '1x', '1x', 2, '1x', '1x', '1x', '1x', '1x', '1x', '1x'};
...
app.SelectPreParamsListLabel.Layout.Column = [1 3];
...
app.SamePreParamListRecordingCheckBox.Layout.Column = [1 3];
